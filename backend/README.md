...
## Project Structure
    ...
    ├── kelevralabs_snipeit_34003  # Django project configurations
...
1. Clone this repo and `cd kelevralabs_snipeit_34003`
...
2. Clone this repo and `cd kelevralabs_snipeit_34003`
